...
const styles = StyleSheet.create({
  ...
  tabBar: { backgroundColor: '#fff', height: 52, borderBottomWidth: 1, borderBottomColor: '#F0F0F0' },
  tabContent: { paddingHorizontal: 12, flexDirection: 'row', alignItems: 'center', height: 52 },
  tab: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20, backgroundColor: '#F5F5F5', marginRight: 8 },
  ...
  dateRow: { flexDirection: 'row', backgroundColor: '#fff', paddingHorizontal: 12, paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: COLORS.lightGray },
  dateChip: { paddingHorizontal: 12, paddingVertical: 5, borderRadius: 16, backgroundColor: COLORS.lightGray, marginRight: 8 },
